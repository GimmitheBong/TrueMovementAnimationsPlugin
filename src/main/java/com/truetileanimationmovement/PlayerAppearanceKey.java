...
final class PlayerAppearanceKey
{
    ...
    static PlayerAppearanceKey From(PlayerComposition Composition)
    {
        ...
        if (Overrides != null)
        {
            ...
            for (int Index = 0; Index < Overrides.length; Index++)
            {
                ...
                if (Override != null)
                {
                    ColorOverrides[Index] = Override.getColorToReplaceWith();
                    TextureOverrides[Index] = Override.getTextureToReplaceWith();
                }
            }
        }
    ...
    boolean Matches(PlayerComposition Composition)
    {
        if (Composition == null ||
                ...
                !Arrays.equals(EquipmentIds, Composition.getEquipmentIds()) ||
        ...
        int CachedOverrideCount = ColorOverrides == null ? 0 : ColorOverrides.length;
        ...
        {
            ColorTextureOverride Override = Overrides[Index];
            short[] ColorsAtIndex = Override == null ? null : Override.getColorToReplaceWith();
            short[] TexturesAtIndex = Override == null ? null : Override.getTextureToReplaceWith();
